...
return [
    ...
    */
    ...
    'password_grant_client' => [
        'name' => env('PASSPORT_GRANT_CLIENT_NAME', env('APP_NAME', 'laravel') . ' Password Grant Client'),
    ],

    'tokens_lifetime' => [
        'minutes_for_access' => env('PASSPORT_ACCESS_TOKEN_LIFETIME_IN_MINUTES', 120),
        'days_for_refresh' => env('PASSPORT_REFRESH_TOKEN_LIFETIME_IN_DAYS', 30),
    ],
